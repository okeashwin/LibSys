...
#    name = 'Book00'+i.to_s
#    authors= 'bookAuthor'+i.to_s+',bookAuthor(i+1.to_s)'
...
Reservation.create(user_id: 23, book_id: 1, dateIssued: Time.now.getutc)
 Reservation.create(user_id: 23, book_id: 2, dateIssued: Time.now.getutc)
 Reservation.create(user_id: 24, book_id: 3, dateIssued: Time.now.getutc)
 Reservation.create(user_id: 23, book_id: 4, dateIssued: Time.now.getutc)